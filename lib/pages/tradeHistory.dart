                    ...
                    builder: ((context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        if (tradeDataList.isEmpty) {
                          ...
                          List<Map<String, dynamic>> filteredTradeDataList =
                              selectedDate == null ||
                                      selectedDate == DateTime.now()
                                  ? tradeDataList
                                  : tradeDataList
                                      .where((trade) =>
                                          ...
                                          selectedDate!.day)
                                      .toList();
                          if (filteredTradeDataList.isNotEmpty) {
                            return Container(
                              ...
                              child: ListView(
                                children: [
                                  ListView.builder(
                                    ...
                                    itemCount: filteredTradeDataList.length,
                                    itemBuilder:
                                        (BuildContext context, int index) {
                                      final trade =
                                          filteredTradeDataList[index];
                                      return GestureDetector(
                                        onTap: () {
                                          showDialog(
                                            context: context,
                                            builder:
                                                (BuildContext tradeDialog) {
                                              return TradeDetails(
                                                status: trade['status'],
